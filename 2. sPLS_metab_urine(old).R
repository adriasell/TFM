...
omics_denoised <- readRDS("./results/denoising/denoising_metab/urine/metab_urine_denoised.RDS")
...
write_xlsx(sPLS_n, "./results/sPLS_results/urine/urine_sPLS_n.xlsx")
write_xlsx(sPLS_s, "./results/sPLS_results/urine/urine_sPLS_s.xlsx")
write_xlsx(sPLS, "./results/sPLS_results/urine/urine_sPLS_all.xlsx")
