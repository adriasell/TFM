...
#OPCIÓ 3 no-SPARSITY (ncomp=1:5, y(1:3))----------------------------------------
...
summary(rgcca_res)
write_rds(rgcca_res, "./results/RGCCA/rgcca_m3.rds")
rgcca_res <- readRDS("./results/RGCCA/rgcca_m3.rds")
...
m3_list<-list("ncomp"=cv_sgcca_ncomp$best_params,
              "R2"=results_R2,
...
save(m3_list, file = "./results/RGCCA/rgcca_m3.RData")
m3_list[1:4]
m3_list[6]
