...
list.of.packages <- c(
  ...
  "ranger","palmerpenguins","tidyverse","kableExtra","haven", "BiocManager", "Biobase", "mixOmics"
)
...
omics_n_denoised <- readRDS("./results/denoising/denoising_methyl/methyl_denoised_n.RDS")
omics_s_denoised <- readRDS("./results/denoising/denoising_methyl/methyl_denoised_s.RDS")
omics_denoised <- readRDS("./results/denoising/denoising_methyl/methyl_denoised.RDS")
...
sPLS_n$results[which(sPLS_n$results$SPLS_MIN.TP=="1"),"var"]
sPLS_s$results[which(sPLS_s$SPLS_MIN.TP$results=="1"),"var"]
sPLS$results[which(sPLS$SPLS_MIN.TP$results=="1"),"var"]

write_xlsx(sPLS_n, "./results/sPLS_results/serum_sPLS_n.xlsx")
write_xlsx(sPLS_s, "./results/sPLS_results/serum_sPLS_s.xlsx")
write_xlsx(sPLS, "./results/sPLS_results/serum_sPLS_all.xlsx")
